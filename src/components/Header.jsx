...
export default function Header({ userSubscription, userName, onLogout, onNavigate }) {
  ...
  return (
    <header className="bg-white border-b border-gray-200 px-6 py-3 flex justify-between items-center">
      <h2 className="text-lg font-bold text-gray-700">مرحباً {userName || 'عميلنا'}</h2>
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="w-10 h-10 rounded-full bg-purple-500 text-white flex items-center justify-center font-bold hover:bg-purple-600 transition-colors"
          >
            {getInitials()}
          </button>
          ...
          {dropdownOpen && (
            <div className="absolute left-0 top-12 w-64 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
              <div className="px-4 py-3 border-b border-gray-100">
                <p className="font-bold text-gray-800">{userName || 'عميل'}</p>
